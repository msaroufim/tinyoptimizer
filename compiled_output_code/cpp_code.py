                       ...
                       float* out_ptr17)
{
    ...
    }
    {
        ...
        auto tmp1 = in_ptr6[static_cast<long>(0L)];
        auto tmp10 = in_ptr7[static_cast<long>(0L)];
        auto tmp18 = in_ptr8[static_cast<long>(0L)];
        auto tmp37 = in_ptr9[static_cast<long>(0L)];
        auto tmp2 = decltype(tmp0)(tmp0 - tmp1);
        auto tmp3 = static_cast<float>(0.10000000149011612);
        auto tmp4 = decltype(tmp3)(tmp3 * tmp2);
        auto tmp5 = static_cast<bool>(0);
        ...
        auto tmp36 = tmp9 / tmp35;
        auto tmp38 = decltype(tmp37)(tmp37 + tmp36);
        out_ptr11[static_cast<long>(0L)] = tmp38;
        out_ptr12[static_cast<long>(0L)] = tmp7;
        out_ptr13[static_cast<long>(0L)] = tmp16;
        out_ptr15[static_cast<long>(0L)] = tmp19;
    }
    {
...
def call(args):
    ...
    cpp_fused_add_addcdiv_addcmul_div_lerp_mul_neg_pow_reciprocal_rsub_sqrt_0(c_void_p(arg8_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(arg6_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg9_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg5_1.data_ptr()), c_void_p(arg7_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg5_1.data_ptr()), c_void_p(arg7_1.data_ptr()), c_void_p(arg6_1.data_ptr()))
    del arg0_1
    del arg1_1
    del arg2_1
    del arg3_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1, 10), (10, 1), device='cpu', dtype=torch.float32)
    arg3_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.float32)
    arg4_1 = rand_strided((1, 10), (10, 1), device='cpu', dtype=torch.float32)
    ...
    arg8_1 = rand_strided((1, 10), (10, 1), device='cpu', dtype=torch.float32)
